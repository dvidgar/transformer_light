...
#            MODEL_NAME = 'B_16'
#            
#        model = ViT(MODEL_NAME, pretrained=False)
#        model.fc = Identity()
#        pytorch_total_params = sum(p.numel() for p in model.parameters())
#        print('\n\n pytorch_total_params ViT', pytorch_total_params)
